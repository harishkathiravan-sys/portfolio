    ...
    <section id="resume" ref={ref} className="relative py-28 sm:py-36">
      ...
      <div className="mt-14 grid gap-5 lg:grid-cols-[1fr_0.9fr]">
        ...
        >
          ...
          <p className="text-[11px] uppercase tracking-[0.3em] text-white/30">Resume</p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <MagneticButton ripple>
              <a href="#contact" className="cta-premium text-[13px] py-3 px-6">
            ...
            <a
              href={resumePath}
              download
              className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-5 py-2.5 text-[13px] font-medium text-white/60 backdrop-blur-sm transition-all duration-300 hover:border-white/15 hover:bg-white/[0.07] hover:text-white/80"
            >
        ...
        >
          <p className="mb-4 text-[11px] font-semibold uppercase tracking-[0.25em] text-white/25">
            Highlights
          </p>
          ...
          <div className="space-y-3">
            {highlights.map((item, i) => (
              <motion.div
                key={i}
                className="flex items-start gap-3.5 rounded-2xl border border-white/[0.04] bg-white/[0.02] px-6 py-5 transition-all duration-300 hover:border-white/[0.08] hover:bg-white/[0.03]"
              ...
              >
                <div className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-white/[0.08]">
