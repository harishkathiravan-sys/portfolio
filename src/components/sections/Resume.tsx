...
export function Resume() {
  ...
  return (
    <section id="resume" ref={ref} className="relative py-24 sm:py-32">
      ...
      <div className="mt-14 grid gap-5 lg:grid-cols-[1fr_0.9fr]">
        ...
        >
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a
              href="#contact"
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-violet-500 to-cyan-400 px-5 py-2.5 text-[13px] font-semibold text-[#030014] shadow-[0_0_30px_rgba(139,92,246,0.2)] transition-all duration-300 hover:shadow-[0_0_50px_rgba(34,211,238,0.25)]"
            >
        ...
        >
          <div className="space-y-3">
            {highlights.map((item, i) => (
              <motion.div
                key={i}
                className="flex items-start gap-3.5 rounded-2xl border border-white/[0.04] bg-white/[0.02] px-5 py-4"
